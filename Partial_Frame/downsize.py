...
if __name__ == '__main__':
    ...
    base_dir = '../Stitched_Video2/' + environment
    partial_frame_dir_10k = os.path.join(base_dir, 'Partial_Frames_10K')
    partial_frame_dir_downsize_half = os.path.join(base_dir, f'Partial_Frames_Downsize_{ratio_name}')
    partial_frame_dir_compression_one_eighth = os.path.join(base_dir, f'Partial_Frames_Compression_{ratio_name}')
